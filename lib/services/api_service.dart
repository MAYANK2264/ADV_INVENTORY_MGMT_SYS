...
class ApiService {
  ...
  Future<List<Item>> getItems() async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl${AppConstants.itemsEndpoint}'),
        headers: _headers,
      );
  ...
  Future<Item?> getItem(String id) async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl${AppConstants.itemsEndpoint}/$id'),
        headers: _headers,
      );
  ...
  Future<SystemStats> getSystemStats() async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl${AppConstants.statsEndpoint}'),
        headers: _headers,
      );
  ...
  Future<List<Activity>> getActivities() async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl${AppConstants.activitiesEndpoint}'),
        headers: _headers,
      );
  ...
  Future<Map<String, dynamic>> getRackOccupancy() async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl${AppConstants.racksEndpoint}'),
        headers: _headers,
      );
  ...
  Future<List<Item>> searchItems(String query) async {
    try {
      final response = await http.post(
        Uri.parse('$_baseUrl${AppConstants.searchEndpoint}'),
        headers: _headers,
